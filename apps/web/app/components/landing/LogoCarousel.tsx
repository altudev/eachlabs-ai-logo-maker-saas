      ...
      >
        ...
        <div
          className={cn(
            ...
            "transition-colors duration-200",
            isHovered &&
              "from-primary/20 to-primary/10 border-primary/20 text-primary"
          )}
          style={{
        ...
        {isHovered && (
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-transparent via-foreground/[0.03] to-transparent" />
        )}
      </div>
    </div>
  )
...
const CarouselColumn = memo(function CarouselColumn({
  logos,
  direction,
  speed = 25,
}: CarouselColumnProps) {
